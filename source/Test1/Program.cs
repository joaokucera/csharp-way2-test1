...
namespace Test1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                catch
                {
                    ...
                    Program.WriteLineWithColor(word, true, ConsoleColor.Red);
        ...
        private static void WriteLineWithColor(object value, bool breakLine = true, ConsoleColor newColor = ConsoleColor.Green)
        {
